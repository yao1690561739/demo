...
public class RedisAspect {
     ...
     */
    @Pointcut("@annotation(com.yao.system.config.redis.annotation.RedisCache)")
    public void redisCachePoint()
    {
    }

    @Pointcut("@annotation(com.yao.system.config.redis.annotation.RedisEvict)")
    ...
    public void evict(JoinPoint point)
    {
        ...
        // 获取RedisCache注解
        String fieldKeys = parseKey(redisEvict.fieldKey(), method, point.getArgs());
        String[] fieldKeyArray= Convert.toStrArray(fieldKeys);
        for (String fieldKey1:fieldKeyArray){
            String rk = redisEvict.key() + "_" + fieldKey1;
